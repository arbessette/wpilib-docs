...
.. tab-set::
   ...
   .. tab-item:: Shared
      ...
      .. grid:: 1
         ...
         .. grid-item-card:: Practice with the XRP
            ...
            **Available Now**
            ^^^
            Learn WPILib programming on the $75 XRP desktop robot; the
   ...
   .. tab-item:: FTC
      ...
      **Systemcore** and **Motioncore** controllers, ahead of the
      2027-2028 season. Still on REV Control Hub / Expansion Hub? Keep
      programming with the FTC SDK as normal; see
